...
function RightPanel({ allColumns, selectedColumns, setSelectedColumns, filter, onFilterChange }) {
  ...
  // Local state for username filter (if not controlled by parent)
        ...
        <div className={styles.panelContent}>
          <div className={styles.filterSection}>
            <label className={styles.filterLabel}>
              <span className={styles.filterLabelText}>Username</span>
              <Input
                id="usernameFilter"
                value={username}
                onChange={e => {
                  ...
                  if (onFilterChange) {
                    onFilterChange({ ...filter, username: e.target.value });
                  }
                }}
