...
import styles from '../Proposal/ProposalMaterialModal.module.scss';
        ...
        <div className={styles.message}>
          <div className={styles.formGrid}>
            <div className={styles.colSpan2}>
              ...
              <Select id="material-select" value={form.materialId || 0} onChange={(e) => handleMaterialSelect(e.target.value)} options={(materials || []).map((m) => ({ value: m.id, label: `${m.name || m.code || ''}`.trim() }))} placeholder="Select material" searchable className={styles.materialSelect} />
            </div>
            <Input id="material-code" label="Material Code" placeholder="Code" value={form.code} onChange={handleChange('code')} readOnly />
            ...
            <div className={styles.inlineRow}>
              ...
              <Input id="material-materialCost" label="Material Cost" type="number" placeholder="Material Cost" value={form.materialCost} readOnly />
              <Input id="material-totalAmount" label="Total Amount" type="number" placeholder="Total Amount" value={form.totalAmount} readOnly />
            </div>
            ...
            <Input id="material-totalAmount2" label="Total Amount" type="number" placeholder="Total Amount" value={form.totalAmount} readOnly />
          </div>
        </div>
